...
post.create().then(function(newId){
   ...
   errors.forEach(() => req.flash("errors", error))
...
//  or user did have permission but, there was a validation errors
if(status == "success"){
...
exports.apiDelete = function(req,res){
  ...
  res.json("you donot have permisssion to perform this action.")
  })
}
